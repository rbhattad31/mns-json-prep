            ...
            if value is not None:
                if all(char == '0' for char in value):
                    if 'percentage_of_shares' in column_json_node:
                        print("0 in normal format for % of shares")
                        value = float(0.00)
                    else:
                        print("0 in normal format for no of shares")
                        value = int(0)
                    ...
                    value = value.split('.')[0]
                    if 'percentage_of_shares' in column_json_node:
                        print("0 in decimal format for % of shares")
                        value = float(0.00)
                    else:
                        print("0 in decimal format for no of shares")
                        value = int(0)
                else:
                    print("The string has no zero.")
                    try:
                        value = float(value)
                    except:
                        pass
                ...
                if 'percentage_of_shares' in column_json_node:
                    print("0 in None for % of shares")
                    value = float(0.00)
                else:
                    print("0 in None for no of shares")
                    value = int(0)
            print(value)
            single_df.at[index, 'Value'] = value
