...
def extract_xfa_data(pdf_path,filename):
    ...
    logging.info(xfa)
    if xfa is not None:
        if 'MSME' in filename or 'AOC' in filename or 'CHG' in filename or 'Form8' in filename or 'FiLLiP' in filename or 'Form 8' in filename or 'Form 18' in filename or 'Form 32' in filename:
