...
from Programs_LLP.Form_8_Interim.Form8_interim_XMLToDB import form8_interim_xml_to_db
...
config_sheet_name = 'Form_8_Interim'
...
xml_file_path = '../../Input/LLP/Form_8_Interim/Form8 (Interim) (2).xml'
# xml to Excel
...
if result:
    print("process complete for form 8 interim")
else:
    print("process failed for form 8 interim")
