...
from Programs_AOC4_NBFC.AOC4_NBFC_XMLToDB import aoc_nbfc_xml_to_db
...
xml_file_path = 'Input/AOC4_NBFC/FORM NO. AOC-4-NBFC (Ind AS) (2).xml'
# xml to Excel
...
result = aoc_nbfc_xml_to_db(db_config, config_dict, map_file_path, map_file_sheet_name,
                            xml_file_path, output_file_path,
                            cin, company_name)

if result:
    print("process complete for aoc nbfc")
else:
    print("process failed for aoc nbfc")
